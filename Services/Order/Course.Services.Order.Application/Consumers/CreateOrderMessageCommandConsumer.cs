...
namespace FreeCourse.Services.Order.Application.Consumers
{
    public class CreateOrderMessageCommandConsumer : IConsumer<CreateOrderMessageCommand>
    {
        ...
        {
            var newAddress = new Course.Services.Order.Domain.OrderAggregate.Address(
                context.Message.Province, 
                context.Message.District, context.Message.Street,
                context.Message.ZipCode, context.Message.Line);

            Course.Services.Order.Domain.OrderAggregate.Order order = new Course.Services.Order.Domain.OrderAggregate.Order(context.Message.BuyerId, newAddress);
